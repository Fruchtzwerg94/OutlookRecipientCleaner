...
namespace OutlookRecipientCleaner.Forms
{
    internal partial class AboutWindow : Form
    {
        ...
        public AboutWindow()
        {
            ...
            this.Text = ThisAddIn.ADD_IN_NAME;
        ...
        private void LinkLabel_Github_LinkClicked(object sender, LinkLabelLinkClickedEventArgs e)
        {
            ...
            Process.Start("https://github.com/Fruchtzwerg94/OutlookRecipientCleaner");
        }
        ...
        private async void Button_CheckForUpdate_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                })
                {
                    ...
                    HttpResponseMessage response = await client.GetAsync("https://api.github.com/repos/Fruchtzwerg94/OutlookRecipientCleaner/releases").ConfigureAwait(true);
